...
public interface QuestionRepository extends JpaRepository<Question, Integer> {
    ...
    Page<Question> findAll(Specification<Question> spec, Pageable pageable); // Specification 인터페이스 사용
    ...
    Page<Question> findAllByKeyword(@Param("kw") String kw, Pageable pageable);  // 쿼리 애너테이션 사용
}
